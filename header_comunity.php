    ...
    <div  id="timelineNav">
        ...
        <ul class="menu-main">
            ...
            <li <?php echo ($page == 'booking') ? "class='active'" : ""; ?>>
                ...
                <a data-toggle="modal" data-target='#coming' href="#"><span class="glyphicon glyphicon-user"></span> Booking</a></li>
            <li <?php echo ($page == 'project') ? "class='active'" : ""; ?>>
                <?php echo $arrow_discover ?>
                <a data-toggle="modal" data-target='#coming' href='#'><span class="glyphicon glyphicon-globe"></span> Project</a></li>
        </ul>
