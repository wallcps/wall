        ...
        <form method="post" action="" name="sign_up" id="sign_up">
            <div style="background-color:#ffffff; text-align: center;">
                ...
                <tr>
                    ...
                    <td >
                        <input type="text" name="usr_phone" class="text-input form-control" style="  width: 89px;float: left;" value="<?php echo $_POST['usr_phone'];?>" AUTOCOMPLETE='OFF'/>
                   
                        <input type="text" name="usr_phone" class="text-input form-control" style="width: 78%;float:right;" value="<?php echo $_POST['usr_phone'];?>" AUTOCOMPLETE='OFF'/>
