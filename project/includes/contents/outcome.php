...
$(document).ready(function(){
    ...
    qy210(".edit_outcome_editor").Editor();
...
function editOutcome(id, title, keyword, content){
        ...
        $('input#edit_outcome_keyword').tagsinput('removeAll');
        $('input#edit_outcome_keyword').tagsinput('add', keyword);
        $('input#edit_outcome_keyword').tagsinput('refresh'); 
}
</script>
    ...
    <div class="text outcome">
        <p class="text-title"><b>Outcomes</b>
            <?php if ($session_group_admin) { ?>
                <span class="text-right"><a href="" data-toggle="modal" data-target="#edit_outcomes" ><i class="glyphicon glyphicon-edit" original-title="Edit Outcome"></i></a></span></p>
                ...
                <div class="col-lg-10 text-style">
                    ...
                    ?>
                     <div class="row aspiration-text">
                        <div class="col-lg-3">
                               <a href="<?php echo $base_url;?>group.php?gid=<?php echo $groupID;?>&ptab=contents&p=each_outcome&oc_id=<?php echo $outcome_id;?>">
                        ...
                        <div class="col-lg-9">
                            <h4 class="media-heading"><a href="<?php echo $base_url;?>group.php?gid=<?php echo $groupID;?>&ptab=contents&p=each_outcome&oc_id=<?php echo $outcome_id;?>"><?php echo $outcome_title; ?></a></h4> 
                            
                        <p>
                         <?php 
                           if (strlen($outcome_content) >= 200) {
                                $outcome_content1 = strip_tags($outcome_content);
                                $trimstrings = (substr($outcome_content1, 0, 200));
                                echo $trimstrings;?>
                                <a href="<?php echo $base_url;?>group.php?gid=<?php echo $groupID;?>&ptab=contents&p=each_outcome&oc_id=<?php echo $outcome_id;?>">Read More</a>
                                <?php } else {
                        ...
                        <div>
                         ...
                         <a href="" data-toggle="modal" data-target="#edit_outcome">
                            <button class="btn btn-social" onclick="editOutcome(<?php echo $outcome_id ?>, '<?php echo $outcome_title ?>', '<?php echo $outcome_keyword ?>', '<?php echo htmlspecialchars(addslashes($outcome_content)) ?>')">
                                Edit
                            </button>
                        </a>
