...
<div  id="nav-group">
    ...
    if($uid==$group_owner_id){ ?>
        ...
        ?>
                <ul>
                    <li><a class='<?php echo $tab=="welcome"?"active":""; ?>' href="<?php echo $base_url; ?>community.php?gid=<?php echo $gid; ?>&com=dashboard&tab=welcome"><i class="glyphicon glyphicon-home"> </i></a></li>
                    <li><a class='<?php echo $tab=="about"?"active":""; ?>' href="<?php echo $base_url; ?>community.php?gid=<?php echo $gid; ?>&com=dashboard&tab=about">ABOUT US</a></li>
                    <li><a class='<?php echo $tab=="volunteer"?"active":""; ?>' href="<?php echo $base_url; ?>community.php?gid=<?php echo $gid; ?>&com=dashboard&tab=volunteer">VOLUNTEER</a></li>
                    <li><a class='<?php echo $tab=="contact"?"active":""; ?>' href="<?php echo $base_url; ?>community.php?gid=<?php echo $gid; ?>&com=dashboard&tab=contact">CONTACT</a></li>
                </ul>
