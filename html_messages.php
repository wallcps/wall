...
<span class="sttext_span">
        <b><a href="<?php echo $base_url;?>index.php?p=each_profile_user&profile_id=<?php echo $uid;?>"><?php echo $Wall->UserFullName($username);?></a></b><?php echo $group_text; ?>
</span>
<?php if($msg_title){
        echo '<b>Title</b>'.$msg_title;
}?>
